...
/////////////////////////////////////////
const AWS = require("aws-sdk/client-organizations");
const https = require("https");
const util = require("util");
const config = require("./config");
const orgs = new AWS.OrganizationsC({ region: "ap-southeast-1" });
...
exports.handler = async function (event, context) {
  ...
  const params = {
    AccountId: '240365136232',
  };
  const response = await orgs.DescribeAccountCommand(params);
  const emailAddress = response.Acc
